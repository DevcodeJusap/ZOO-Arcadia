...
<head>
    ...
    <meta name="description" content="Découvrez les différents habitats des animaux au Zoo-Arcadia.">
    <meta name="keywords" content="zoo, animaux, habitats, savane, forêt, désert">
    <link rel="icon" type="image" href="image/presentation/logo.webp">
    <title>Zoo-Arcadia - Habitat</title>
    <link rel="stylesheet" href="css/habitats.css">
</head>
<body id="habitat.html">
    <header>
